...
describe('source-utils tests', () => {
  ...
  test('getDecorationRows', async () => {
    ...
    const fn = getDecorationRowsFn as unknown as (...args: typeof getDecorationRows.args) => unknown
    expect(cleanResults(fn(...getDecorationRows.args))).toEqual(getDecorationRows.ret)
  })
})
