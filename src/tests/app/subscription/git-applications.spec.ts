  ...
  () => {
    ...
    test(
      ...
      async ({
        ...
        await applicationListPage.expectApplicationDiscoverableViaSearchAndTypeFilter(
          applicationName
        );
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-1071', '@create'] },
      async ({
        page,
        oc,
        applicationListPage,
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-7556', '@create', '@ocpInterop', '@post-upgrade'] },
      async ({
        page,
        applicationListPage,
        applicationDetailsPage,
        ...
        const crsSub1 = subscriptionDetailsClusterResourceTotalPattern(
          expectations.clusterResources[0]!.length
        );
        const crsSub2 = subscriptionDetailsClusterResourceTotalPattern(
          expectations.clusterResources[1]!.length
        );
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-7554', '@edit', '@post-upgrade'] },
      async ({
        page,
        oc,
        applicationListPage,
        ...
        await verifySubscriptionAppTopologyTab({
          ...
          mergedSubscriptionBlocks: [
            {
              blockIndex: 1,
              clusterResourceRows: baseExpectations.topologyClusterResourceBlocks[0]!,
            },
            {
              blockIndex: 2,
              clusterResourceRows: addExpectations.topologyClusterResourceBlocks[0]!,
            },
          ],
        });
      }
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-1427', '@edit'] },
      async ({
        page,
        oc,
        applicationListPage,
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-7555', '@edit', '@post-upgrade'] },
      async ({
        page,
        oc,
        applicationListPage,
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-7557', '@destroy', '@ocpInterop', '@post-upgrade'] },
      async ({ page, applicationListPage, subscriptionApplicationCreateWizardPage }) => {
        test.setTimeout(240_000);
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-39232', '@create'] },
      async ({
        page,
        oc,
        ...
        await editSubscriptionInExistingApplication(
          ...
          page,
          {
            ...
            entry: 'details',
            perBlock: [
              { clusterDeployment: buildGlobalClusterLabelDeployment(managedCluster.name) },
            ],
          }
        );
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-41356', '@create'] },
      async ({
        page,
        oc,
        applicationListPage,
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-7513', '@edit'] },
      async ({
        page,
        oc,
        applicationListPage,
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-49630', '@edit'] },
      async ({
        page,
        oc,
        applicationListPage,
        ...
        const subscriptionCrName = defaultSubscriptionCrName(applicationName, 1);
        await expect
          .poll(() => oc.getSubscriptionPlacementRefName(namespace, subscriptionCrName), {
            timeout: 60_000,
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-39666', '@create'] },
      async ({ page, oc, applicationListPage, subscriptionApplicationCreateWizardPage }) => {
        test.setTimeout(300_000);
        const { subscription: options, applicationExpectations: expectations } =
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-7487', '@destroy', '@ocpInterop'] },
      async ({ page, applicationListPage, subscriptionApplicationCreateWizardPage }) => {
        test.setTimeout(240_000);
    ...
    test(
      ...
      { tag: ['@e2e-common', '@e2e', '@RHACM4K-10668', '@create'] },
      async ({
        page,
        oc,
        managedClusterContext,
