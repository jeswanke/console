...
export const rbacPresets = {
  ...
  users: [
    ...
    {
      role: 'fg-rbac-clusterset-61863',
      username: 'clc-e2e-clusterset-61863',
      domains: ['fg-rbac'],
    },
    ...
    {
      role: 'fg-rbac-reviewdiff-61825',
      username: 'clc-e2e-reviewdiff-61825',
      domains: ['fg-rbac'],
    },
    ...
    {
      role: 'fg-rbac-projmismatch-61865',
      username: 'clc-e2e-projmismatch-61865',
      domains: ['fg-rbac'],
    },
    { role: 'fg-rbac-delete-61866', username: 'clc-e2e-delete-61866', domains: ['fg-rbac'] },
    {
      role: 'fg-rbac-cpadvanced-61867',
      username: 'clc-e2e-cpadvanced-61867',
      domains: ['fg-rbac'],
    },
    {
      role: 'fg-rbac-scopechange-61944',
      username: 'clc-e2e-scopechange-61944',
      domains: ['fg-rbac'],
    },
    ...
    {
      role: 'fg-rbac-std-view-60309',
      username: 'clc-e2e-std-view-60309',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-std-edit-60309',
      username: 'clc-e2e-std-edit-60309',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-std-admin-60309',
      username: 'clc-e2e-std-admin-60309',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-hub-view-only-60310',
      username: 'clc-e2e-hub-view-only-60310',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-hub-admin-60311',
      username: 'clc-e2e-hub-admin-60311',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-managed-view-60467',
      username: 'clc-e2e-managed-view-60467',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-managed-admin-60468',
      username: 'clc-e2e-managed-admin-60468',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-spoke-view-ns-60302-60306',
      username: 'clc-e2e-spoke-view-ns-60302-60306',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-group-last-60307',
      username: 'clc-e2e-group-last-60307',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-idp-kubevirt-60257',
      username: 'clc-e2e-idp-kubevirt-60257',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-idp-vm-60258',
      username: 'clc-e2e-idp-vm-60258',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-ldap-admin-60258',
      username: 'qe-admin-user',
      idp: 'qe-ldap',
      password: 'qe-admin-user',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-search-61846',
      username: 'clc-e2e-search-61846',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
      role: 'fg-rbac-view-cluster-59195',
      username: 'clc-e2e-view-cluster-59195',
      domains: ['fg-rbac', 'fleet-virt'],
    },
    {
    ...
    {
      role: 'fg-rbac-operator-60239',
      username: 'clc-e2e-operator-60239',
      domains: ['fg-rbac', 'fleet-virt'],
    },

    // --- Tier: full (CCLM tests, Azure only) ---
    {
      role: 'fg-rbac-cclm-admin-60989',
      username: 'clc-e2e-cclm-admin-60989',
      domains: ['fg-rbac', 'fleet-virt'],
    },
  ],
} as const;
